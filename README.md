...
- [waveshareteam/LCD-show](https://github.com/waveshareteam/LCD-show) - 
...
- [raspberrypi-ui/lxpanel](https://github.com/raspberrypi-ui/lxpanel) - 
...
- [stuntrally/tracks](https://github.com/stuntrally/tracks) - Note: development in tracks3 repo. Tracks of Stunt Rally 2.x. Meant to be inside data/tracks/.
...
- [Gold872/elastic-dashboard](https://github.com/Gold872/elastic-dashboard) - A simple and modern dashboard for FRC
...
- [YvanTT/arTIfiCE](https://github.com/YvanTT/arTIfiCE) - arTIfiCE is a jailbreak for TI CE calculators with OS 5.5 and later. It brings back ASM programs and games.
...
- [phthallo/terminal-website](https://github.com/phthallo/terminal-website) - Frontend for my personal Linux terminal-style website! (complete with Hyfetch)
...
- [scris/skim-pdf](https://github.com/scris/skim-pdf) - Skim is a PDF viewer on macOS, with the main repository on SourceForge. This is the skim git clone with full git history until Jan 2024.
- [MacEnhance/BootBuddy](https://github.com/MacEnhance/BootBuddy) - :computer: Customize the boot, login screen and boot options on macOS
...
- [nfzerox/ipod_theme](https://github.com/nfzerox/ipod_theme) - Theme your iPod nano 7th and 6th generation with custom icons, wallpapers, clock faces, change or hide labels, apply custom font, and more.
...
- [guillaumeboehm/Nordzy-cursors](https://github.com/guillaumeboehm/Nordzy-cursors) - Cursor theme using the Nord color palette and based on Vimix and cz-Viator.
